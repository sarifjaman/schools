...
class StudentFeeController extends Controller
{
    ...
    //Student Fee Class Wise Get
    public function studentfeeclasswiseget(Request $request)
    {
        ...
        $html['thsource'] .= '<th>Fee (Student Fee)</th>';
        ...
        foreach ($data as $key => $std) {
            ...
            $html[$key]['tdsource'] .= '<td>' . $std['student']['fathername'] . '<input type="hidden" name="class_id" value="' . $std->class_id . '" >' . '</td>';
            $html[$key]['tdsource'] .= '<td>' . $registrationfee->amount . '/-' . '<input type="hidden" name="date" value="' . $date . '">' . '</td>';
            $html[$key]['tdsource'] .= '<td>' . $std['discount']['discount'] . '%' . '</id>';
