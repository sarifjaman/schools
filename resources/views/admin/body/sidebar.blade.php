...
<li class="treeview {{ $prefix == '/profile' ? 'active' : '' }}">
  <a href="#">
    <i class="fa fa-user-circle"></i> <span>User Profile</span>
    <span class="pull-right-container">
      <i class="fa fa-angle-right pull-right"></i>
    </span>
  </a>
...
<li class="treeview {{ $prefix == '/setups' ? 'active' : '' }}">
  <a href="#">
    <i class="far fa-tools"></i> <span>Setup Management</span>
    <span class="pull-right-container">
      <i class="fa fa-angle-right pull-right"></i>
    </span>
  </a>
  <ul class="treeview-menu">
    <li><a href="{{ route('student.class.view') }}"><i class="ti-more"></i>Student Class Show</a></li>
    <li><a href="{{ route('student.year.view') }}"><i class="ti-more"></i>Student Year Show</a></li>
    <li><a href="{{ route('student.group.show') }}"><i class="ti-more"></i>Student Group Show</a></li>
    <li><a href="{{ route('fee.category.show') }}"><i class="ti-more"></i>Fee Category Show</a></li>
    <li><a href="{{ route('fee.amount.show') }}"><i class="ti-more"></i>Fee Amount Show</a></li>
    <li><a href="{{ route('exam.type.show') }}"><i class="ti-more"></i>Exam Type Show</a></li>
    <li><a href="{{ route('school.subject.show') }}"><i class="ti-more"></i>School Subject Show</a></li>
    <li><a href="{{ route('assign.subject.show') }}"><i class="ti-more"></i>Assign Subject Show</a></li>
    <li><a href="{{ route('designation.show') }}"><i class="ti-more"></i>Designation Show</a></li>
  </ul>
</li>
...
<li class="treeview {{ $prefix == '/students' ? 'active' : '' }}">
  <a href="#">
    <i class="fa fa-graduation-cap" aria-hidden="true"></i> <span>Student Management</span>
    <span class="pull-right-container">
      <i class="fa fa-angle-right pull-right"></i>
    </span>
  </a>
  ...
  <ul class="treeview-menu">
    ...
    <li><a href="{{ route('student.exam.fee.view') }}"><i class="ti-more"></i>Student Exam Fee</a></li>
  </ul>
</li>
...
<li class="treeview {{ $prefix == '/employees' ? 'active' : '' }}">
  ...
  <ul class="treeview-menu">
    ...
    <li><a href="{{ route('employee.salary.view') }}"><i class="ti-more"></i>Employee Salary View</a></li>
    <li><a href="{{ route('employee.leave.view') }}"><i class="ti-more"></i>Employee leave View</a></li>
    <li><a href="{{ route('employee.attendance.view') }}"><i class="ti-more"></i>Employee Attendance View</a></li>
    <li><a href="{{ route('employee.monthlysalary.view') }}"><i class="ti-more"></i>Employee Monthly Salary View</a></li>
  </ul>
</li>
