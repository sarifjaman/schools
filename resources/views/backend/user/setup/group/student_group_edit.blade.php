    ...
    <div class="container-full">
      ...
      <div class="content-header">
          <div class="d-flex align-items-center">
              <div class="mr-auto">
                  <h3 class="page-title">Edit Student Group Page</h3>
                  <div class="d-inline-block align-items-center">
                      <nav>
                          <ol class="breadcrumb">
                              <li class="breadcrumb-item"><a href="{{ route('dashboard') }}"><i class="mdi mdi-home-outline"></i></a></li>
                              <li class="breadcrumb-item" aria-current="page">Edit Student Group</li>
                  ...
                  <form novalidate="" action="{{ route('student.group.update',$data->id) }}" method="POST">
                    ...
                    <div class="row">
                      ...
                      <div class="text-xs-right">
                        <input type="submit" value="Student Group Update" class="btn btn-info btn-rounded" />
                    </div>
                      </div>
                  </form>
