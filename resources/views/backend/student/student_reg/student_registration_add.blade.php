    ...
    <div class="container-full">
      ...
      <div class="content-header">
          <div class="d-flex align-items-center">
              <div class="mr-auto">
                  <h3 class="page-title">Add Student Page</h3>
          ...
          <div class="box-body">
            <div class="row">
              <div class="col">
                  ...
                  <form novalidate="" action="{{ route('store.student.registration') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                      ...
                      <div class="text-xs-right">
                        <input type="submit" value="Student Add" class="btn btn-info btn-rounded" />
                    </div>
                      </div>
                  </form>
