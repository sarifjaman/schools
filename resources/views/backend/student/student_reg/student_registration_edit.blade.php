    ...
    <div class="container-full">
      ...
      <div class="content-header">
          <div class="d-flex align-items-center">
              <div class="mr-auto">
                  <h3 class="page-title">Edit Student Registration Page</h3>
                  <div class="d-inline-block align-items-center">
                      <nav>
                          <ol class="breadcrumb">
                              <li class="breadcrumb-item"><a href="{{ route('dashboard') }}"><i class="mdi mdi-home-outline"></i></a></li>
                              <li class="breadcrumb-item" aria-current="page">Edit Student Registration</li>
          ...
          <div class="box-body">
            <div class="row">
              <div class="col">
                  ...
                  <form novalidate="" action="{{ route('student.registration.update',$editdata->student_id) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 col-md-4">
                                <div class="form-group">
                                    ...
                                    <div class="controls">
                                        <input type="date" id="dob" name="dob" value="{{ (!is_null($editdata['student']['dob']))  ? date('m-d-Y', strtotime($editdata['student']['dob'])) : ''}}" class="form-control" required=""> 
                                        <div class="help-block"></div>
                                    </div>
                                </div>
                            </div>
