    ...
    <div class="container-full">
      ...
      <div class="content-header">
          <div class="d-flex align-items-center">
              <div class="mr-auto">
                  <h3 class="page-title">Update Employee Leave Page</h3>
                  <div class="d-inline-block align-items-center">
                      <nav>
                          <ol class="breadcrumb">
                              <li class="breadcrumb-item"><a href="{{ route('dashboard') }}"><i class="mdi mdi-home-outline"></i></a></li>
                              <li class="breadcrumb-item" aria-current="page">Update Employee Leave</li>
          ...
          <div class="box-body">
            <div class="row">
              <div class="col">
                  ...
                  <form novalidate="" action="{{ route('employee.leave.update',$editdata->id ) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-12 col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="controls">
                                        <input type="date" name="start_date" value="{{ $editdata->start_date }}" id="" class="form-control" required=""> 
                            ...
                            <div class="col-12 col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="controls">
                                        <input type="date" name="end_date" value="{{ $editdata->end_date }}" id="" class="form-control" required=""> 
                                        <div class="help-block"></div>
                                    </div>
                                </div>
                            </div>
